...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> add(long userId, RequestBookingDto bookingDto) {
    ...
    public ResponseEntity<Object> accept(long bookingId, long userId, boolean approved) {
